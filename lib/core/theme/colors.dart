...
class AppColors {
  static const Color primary = Color(0xFFFF5F0C); // اللون الأساسي
  static const Color secondary = Color(0xFF01236A); // اللون الثانوي
  static const Color third = Color(0xFF017EFF); // اللون الثانوي
  static const Color background = Color(0xFFF2F2F7); // لون الخلفية
