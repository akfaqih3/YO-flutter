...
Map<String, String> ar = {
  ...
  lblOrderBy: 'الترتيب حسب',
  lblOrderByPriceBefore: 'السعر قبل',
  lblOrderByPriceAfter: 'السعر بعد',
  lblOrderByStartDate: 'تاريخ البدء',
  lblOrderByEndDate: 'تاريخ الانتهاء',
  lblOrderByDiscount: 'نسبة الخصم%',
  lblOrderByDistance: 'المسافة',
  lblOrderByLatest: 'الأحدث',
  lblOrderByMostPopular: 'الشعبية',
  lblOrderByNearby: 'الاقرب',
