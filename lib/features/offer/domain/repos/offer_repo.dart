...
abstract class OfferRepo {
  Future<Either<Failure, List<OfferCategoryEntity>>> getOfferCategoriesByCategory(String categorySlug);
  Future<Either<Failure, OfferEntity>> getOfferDetails(String storeSlug, String slug);
  Future<Either<Failure, List<OfferEntity>>> getOffers(String storeSlug);
